...
public class ProductController {
	...
	public String addProduct( @ModelAttribute("product") Product product, @RequestParam("uploadFile") MultipartFile multipartFile, HttpSession session ) throws Exception {
		/*String path=session.getServletContext().getRealPath("uploadFile");
		System.out.println("path: "+path);
		*/
		String path = "C:\\Users\\Bit\\git\\repository7\\07.Model2MVCShop(URI,pattern)\\WebContent\\uploadFile";
